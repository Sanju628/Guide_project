                        ...
                        <div class="col-xs-12 col-sm-6 col-md-3 col-lg-4">
                            <a href="">
                                <div class="card-flyer">
                                    <div class="text-box">
                                        <div class="image-box">
                                            <img src="https://bitxorbyteshome.files.wordpress.com/2019/11/blog-cover.png" alt="TIME COMPLEXITY" />
                                        </div>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-3 col-lg-4">
                            <a href="">
                                <div class="card-flyer">
                                    <div class="text-box">
                                        <div class="image-box">
                                            <img src="https://i2.wp.com/coderforevers.com/wp-content/uploads/2017/06/Arrays.png?resize=930%2C512&ssl=1" alt="array" />
                                        </div>
                                        <div class="text-container">                                    
                                            <h6>ARRAY</h6>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-3 col-lg-4">
                            <a href="">
                                <div class="card-flyer">
                                    <div class="text-box">
                                        <div class="image-box">
                                            <img src="https://embed-ssl.wistia.com/deliveries/70d6f4e10e2badb5ef394f00c17ad2bc1c14f6e7.jpg" alt="SORTING ALGORITHMS" />
                                        </div>
                                        <div class="text-container">                                    
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-3 col-lg-4">
                            <a href="">
                                <div class="card-flyer">
                                    <div class="text-box">
                                        <div class="image-box">
                                            <img src="https://cdn.educba.com/academy/wp-content/uploads/2021/05/Binary-Tree-in-Data-Structure.jpg" alt="BINARY TREE" />
                                        </div>
                                        <div class="text-container">
                                            <h6>BINARY TREE</h6>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-3 col-lg-4">
                            <a href="">
                                <div class="card-flyer">
                                    <div class="text-box">
                                        <div class="image-box">
                                            <img src="https://i.ytimg.com/vi/VVXOE-hnFts/maxresdefault.jpg" alt="BINARY SEARCH TREE" />
                                        </div>
                                        <div class="text-container">                                    
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-3 col-lg-4">
                            <a href="">
                                <div class="card-flyer">
                                    <div class="text-box">
                                        <div class="image-box">
                                            <img src="https://i.ytimg.com/vi/B8ugj1jq2Lg/maxresdefault.jpg" alt="GREEDY Algorithms" />
                                        </div>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-3 col-lg-4">
                            <a href="">
                                <div class="card-flyer">
                                    <div class="text-box">
                                        <div class="image-box">
                                            <img src="https://ibpublicimages.s3-us-west-2.amazonaws.com/tutorial/backtracking1.png" alt="BACKTRACKING ALGORITHMS" />
                                        </div>
                                        <div class="text-container">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-3 col-lg-4">
                            <a href="">
                                <div class="card-flyer">
                                    <div class="text-box">
                                        <div class="image-box">
                                            <img src="https://cdn.educba.com/academy/wp-content/uploads/2020/01/Stack-in-Data-Structure.jpg" alt="STACK DATA STRUCTURE" />
                                        </div>
                                        <div class="text-container">                                    
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-3 col-lg-4">
                            <a href="">
                                <div class="card-flyer">
                                    <div class="text-box">
                                        <div class="image-box">
                                            <img src="https://cdn.educba.com/academy/wp-content/uploads/2019/12/Queue-in-Data-Structure.jpg" alt="QUEUE DATA STRUCTURE" />
                                        </div>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-3 col-lg-4">
                            <a href="">
                                <div class="card-flyer">
                                    <div class="text-box">
                                        <div class="image-box">
                                            <img src="https://raw.githubusercontent.com/sumitc91/sumitc91.github.io/master/Blogs/80944397-ba9b-4d97-bcce-176b789b4f04_Heap-Data-Structure.jpg" alt="HEAP DATA STRUCTURE"/>
                                        </div>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-3 col-lg-4">
                            <a href="">
                                <div class="card-flyer">
                                    <div class="text-box">
                                        <div class="image-box">
                                            <img src="https://cdn.hashnode.com/res/hashnode/image/upload/v1606947782448/HVa7tDctC.png?w=1600&h=840&fit=crop&crop=entropy&auto=compress" alt="BIT MANIPULATION" />
                                        </div>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-3 col-lg-4">
                            <a href="">
                                <div class="card-flyer">
                                    <div class="text-box">
                                        <div class="image-box">
                                            <img src="https://miro.medium.com/max/14936/1*0DEK_ouEZZz4_MMdhKE_Wg.png" alt="GRAPH ALGORITHMS" />
                                        </div>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-3 col-lg-4">
                            <a href="">
                                <div class="card-flyer">
                                    <div class="text-box">
                                        <div class="image-box">
                                            <img src="https://i.ytimg.com/vi/-urNrIAQnNo/mqdefault.jpg" alt="TRIE DATA STRUCTURE" />
                                        </div>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-3 col-lg-4">
                            <a href="">
                                <div class="card-flyer">
                                    <div class="text-box">
                                        <div class="image-box">
                                            <img src="https://i.ytimg.com/vi/aPQY__2H3tE/maxresdefault.jpg" alt="DYNAMIC PROGRAMING"/>
                                        </div>
